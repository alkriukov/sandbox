function hello(message) {
    console.log('JS supports classic function declaration: function name(args) { body }');
    console.log(message);
};
...
const helloExpression = function(message) {
    console.log('But usually one can see so called FUNCTION EXPRESSIONS: const name = function(args) { body }');
    console.log(message);
};
helloExpression('It is invoked in the same way: name(args)');
