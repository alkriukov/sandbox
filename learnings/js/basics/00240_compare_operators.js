...
let d = { value: 5 };
let e = c;
console.log(`Basic compare of different objects with same properties "{ value: 5 } == { value: 5 }" gives ${c == d}`);
console.log(`Basic compare of objects REFERENCING to same item "c = { value: 5 }; e = c" gives ${c == e}`);
console.log(`Scrict compare of objects REFERENCING TO same item "c = { value: 5 }; e = c" gives also ${e === c}`);
